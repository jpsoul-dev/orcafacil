        ...
        <div className="space-y-6">
          <div className="space-y-3">
            ...
            <p className="text-white/75 text-lg leading-relaxed">
              Crie sua conta em segundos e comece a emitir orçamentos profissionais para seus clientes.
            </p>
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              'Link de compartilhamento único por orçamento',
              'Configurações de empresa com logo',
            ].map((item, i) => (
          ...
          <form action={handleRegister} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="font-medium">
                Senha <span className="text-muted-foreground font-normal text-xs">(mínimo 6 caracteres)</span>
              </Label>
              <Input
                id="password"
                name="password"
