...
const Hashids = require('hashids/dist/hashids').default
...
const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY // Using anon key, hope RLS allows update or I can disable it temporarily
