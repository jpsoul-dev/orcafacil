-- Migration: Adicionar campo whatsapp à tabela companies e atualizar RPC get_quote_details
-- Created: 2026-06-09
-- Path: supabase/migrations/20260609040000_add_whatsapp_to_companies.sql

-- 1. Adicionar coluna whatsapp
ALTER TABLE public.companies ADD COLUMN IF NOT EXISTS whatsapp text;

-- 2. Recriar a RPC get_quote_details retornando whatsapp no objeto company
         ...
         jsonb_build_object(
             ...
             'company', (
                 SELECT jsonb_build_object(
                     'name', c.name,
                     'phone', c.phone,
                     'whatsapp', c.whatsapp, -- Adicionado whatsapp
                     'logo_url', c.logo_url,
                     'cnpj', c.cnpj,
