-- Migration: Adicionar campo email à tabela companies e atualizar RPC get_quote_details
-- Created: 2026-06-09
-- Path: supabase/migrations/20260609050000_add_email_to_companies.sql

-- 1. Adicionar coluna email
ALTER TABLE public.companies ADD COLUMN IF NOT EXISTS email text;

-- 2. Recriar a RPC get_quote_details retornando email no objeto company
         ...
         jsonb_build_object(
             ...
             'company', (
                 SELECT jsonb_build_object(
                     ...
                     'phone', c.phone,
                     'whatsapp', c.whatsapp,
                     'email', c.email, -- Adicionado email
                     'logo_url', c.logo_url,
                     'cnpj', c.cnpj,
